...
try:
    ...
    assert default_attribute_checkbox_robot is None, ' чекбокс не должен быть нажат по дефолту'
    ...
    assert default_attribute_radio_robots is None, ' чекбокс не должен быть нажат по дефолту'
